...
router.post('/', (req,res,next) => {
    ...
    doc.save((err, data) => {
        ...
        res.status(200).send({success : {message: "Created user success"}});
    })
})
...
router.delete('/:_id', (req,res,next) => {
    User.findByIdAndRemove(req.params._id ,(err, data) => {
        ...
        res.status(200).send({success : {message: "Deleted user success"}});
    })
})
...
router.put('/', (req,res,next) => {
    User.findByIdAndUpdate(req.params._id ,req.body ,(err, data) => {
        ...
        res.status(200).send({success : {message: "Updated user success"}});
    })
})
